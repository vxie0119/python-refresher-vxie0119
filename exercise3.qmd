...
def monty_hall(ndoors, ntrials):
    ...
    for i in range(ntrials):
        ...
        switch_choice = [i for i in range(ndoors) if i != choice and i != monty_open[0]]

        # checks if player wins with switch strategy
        if door[switch_choice] == 'car':
            switch_wins += 1
...
print(f"3 Door - Switch Strategy Win Proportion: {}".format(switch_wins_3))
print(f"3 Door - No Switch Strategy Win Proportion: {}".format(no_switch_wins_3))
print(f"5 Door - Switch Strategy Win Proportion: {}".format(switch_wins_5))
print(f"5 Door - No Switch Strategy Win Proportion: {}".format(no_switch_wins_5))
```